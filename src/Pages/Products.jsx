...
const Products = () => {
    ...
    return (
        <div>
            ...
            {
                product.length === 0 ? <p className="text-center justify-center my-52 items-center font-semibold text-7xl">No Element Found</p> : <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 px-6 md:px-48 lg:px-60">{product.map(product => <ProductsCard key={product._id} product={product}></ProductsCard>)}</div>
            }
        </div>
    );
};
